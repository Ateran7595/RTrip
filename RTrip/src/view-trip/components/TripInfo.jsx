  ...
  return (
    <div>
        <div className="font-robotoSlab p-3 m-4">
            ...
            <div>
              <img src={photoURL} alt="destination" className="lg:w-[1400px] xs:w-full md:h-[450px] xs:h-[300px] m-auto mt-3 rounded-xl object-cover" />
            </div>
            <div className="mt-4 md:w-[50%] xs:w-full xs:text-center flex flex-col items-center m-auto p-6 rounded-xl text-[22px] bg-orange-100">
            ...
            <div className="md:w-[85%]  flex flex-col items-center text-center md:p-6 m-auto">
              <h2 className="md:pl-4 xs:pt-3 text-[30px] font-bold">Description:</h2> 
              <p className="md:pl-6 md:pt-2 xs:p-2  text-[21px]">{trip?.tripData?.travelPlanDetails?.suggestedDestination?.description}</p> 
            </div>  
        </div>
    </div>
  )
